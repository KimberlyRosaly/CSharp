...
class Program
{
    static void Main()
    {
        ...
        errors.Add("not an integer", "ERROR - INVALID ENTRY - NOT A NUMBER - PLEASE TRY AGAIN");
        errors.Add("not in range", "ERROR - INVALID ENTRY - ENTRY NOT FOUND - PLEASE TRY AGAIN");
        // =====================================================
        // =======================================DISPLAY VALUES
        int index = 1;
        ...
        do
        {
            ...
            {
                Console.WriteLine(errors["not an integer"]);
            }
            else if (selectionToInteger < 1 || selectionToInteger > words.Count)
            {
                Console.WriteLine(errors["not in range"]);
            }
            else
            {
                break;
